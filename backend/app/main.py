...
app.include_router(update_post_router, prefix="/posts", tags=["Posts"])
app.include_router(delete_post_router, prefix="/posts", tags=["Posts"])
app.include_router(get_all_posts_router, prefix="/posts", tags=["Posts"])
app.include_router(like_post_router, prefix="/posts", tags=["Posts"])
app.include_router(dislike_post_router, prefix="/posts", tags=["Posts"])
app.include_router(vote_poll_router, prefix="/posts", tags=["Posts"])
app.include_router(unvote_poll_router, prefix="/posts", tags=["Posts"])
app.include_router(get_posts_for_user_router, prefix="/posts", tags=["Posts"])
app.include_router(get_posts_of_user_router, prefix="/posts", tags=["Posts"])